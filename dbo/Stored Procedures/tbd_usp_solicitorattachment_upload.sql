CREATE procedure [dbo].[tbd_usp_solicitorattachment_upload]
...
begin
	...
	values (@arn, 'SolicitorDPSubmission', @attachmentfilename, @attachmentcontent, @attachmentfiletype, @attachmentuploaddate, getdate(),getdate(), @checksum)
end